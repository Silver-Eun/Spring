...
public class BoardRestController {
    ...
    public BaseResponse<List<Board>> getList(
            @Parameter BoardSearchParameter parameter,
    ...
    public BaseResponse<Board> get(@PathVariable int boardSeq, Model model) {
    ...
    @RequestConfig(loginCheck = false)
    public String edit(@PathVariable(required = true) int boardSeq,
